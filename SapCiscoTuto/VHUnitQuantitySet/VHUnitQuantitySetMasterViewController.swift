//
// VHUnitQuantitySetMasterViewController.swift
// SapCiscoTuto
//
...
class VHUnitQuantitySetMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private var entities: [VHUnitQuantity] = [VHUnitQuantity]()
    private let logger = Logger.shared(named: "VHUnitQuantityMasterViewConterollerLogger")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let vhunitquantity = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "Msehi", value: "\(vhunitquantity.msehi!)")
        return cell
    }
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.gwsamplebasicEntities.fetchVHUnitQuantitySet(matching: query) { vHUnitQuantitySet, error in
            guard let vHUnitQuantitySet = vHUnitQuantitySet else {
                completionHandler(error!)
                return
            }
            self.entities = vHUnitQuantitySet
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! VHUnitQuantitySetDetailViewController
            detailViewController.entity = selectedEntity
            detailViewController.navigationItem.leftItemsSupplementBackButton = true
            detailViewController.navigationItem.title = self.entities[(self.tableView.indexPathForSelectedRow?.row)!].msehi ?? ""
...
extension VHUnitQuantitySetMasterViewController: EntitySetUpdaterDelegate {
